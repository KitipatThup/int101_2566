...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to use 1.2-1.4 and
        ...
        System.out.println(Utilitor.computeIsbn10(1000000001));
        System.out.println(Utilitor.computeIsbn10(1100000004));
        System.out.println(Utilitor.computeIsbn10(1234567890));
        System.out.println(Utilitor.computeIsbn10(1111111115));
        System.out.println(Utilitor.computeIsbn10(1111111117));
        System.out.println(Utilitor.computeIsbn10(1234552341));
        System.out.println(Utilitor.computeIsbn10(1234554321));
        System.out.println(Utilitor.computeIsbn10(0000000001));
        System.out.println(Utilitor.computeIsbn10(1201314525));
        System.out.println(Utilitor.computeIsbn10(2222222333L));
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to use 2.6-2.10
        ...
        Person p = new Person("qwer", "qwerty");
        System.out.println(p);
        Person s = new Person("aa", "aaaa");
        System.out.println(s);
        Person q = new Person("qwer", "qwerty");
        System.out.println(q);
        System.out.println("Is q equals p = " + q.equals(p));
    }
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to use 3.6-3.12
        ...
        Account a = new Account(new Person("qwer", "qwer"));
        Account b = new Account(new Person("qwer", "qwer"));
        ...
        try {
            ...
            System.out.println("amount cannot less than zero");
        }
        System.out.println(a);
        System.out.println(b);
        a.withdraw(50);
